...
const Formulario = ({ pacientes, setPacientes, paciente, setPaciente }) => {
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5">
       ...
       <form className="bg-white shadow-md rounded-lg py-10 px-5 mb-10 mx-5 opacity-90 " onSubmit={handleSubmit}>
          <div className="mb-5">
          ...
          <input type="submit" className="bg-indigo-600  w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 cursor-pointer transition-colors rounded-lg " value= { paciente.id ? 'Editar Paciente' : 'Agregar Paciente' } />
